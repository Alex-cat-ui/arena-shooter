...
static func _validate_ai_balance(result: ValidationResult) -> void:
	...
	if not pursuit.is_empty():
		...
		_validate_number_key(result, pursuit, "combat_dark_search_node_sample_radius_px", "ai_balance.pursuit", 1.0, 2000.0)
		_validate_number_key(result, pursuit, "combat_dark_search_boundary_radius_px", "ai_balance.pursuit", 1.0, 2000.0)
		_validate_number_key(result, pursuit, "combat_dark_search_node_dwell_sec", "ai_balance.pursuit", 0.01, 30.0)
