...
func _test_refactor_kpi_contracts() -> void:
	...
	_t.run_test(
		...
		_contains_all(
			...
			[
				...
				"@export var kpi_patrol_preavoid_events_min",
				"@export var kpi_patrol_collision_repath_events_max",
				"@export var kpi_patrol_hard_stalls_per_min_max",
				"@export var kpi_patrol_zero_progress_windows_max",
	...
	var phase19_gate_scenes := [
		...
		"res://tests/test_patrol_navigation_kpi_gate.tscn",
	...
	_t.run_test(
		...
		_contains_all(
			...
			[
				...
				"const PATROL_NAVIGATION_KPI_GATE_TEST_SCENE := ",
				...
				"_scene_exists(PATROL_NAVIGATION_KPI_GATE_TEST_SCENE)",
				...
				"Patrol navigation KPI gate suite",
	...
	_t.run_test(
		...
		_contains_all(
			...
			[
				...
				"patrol_navigation_gate_pass",
				"patrol_navigation_kpi_gate_failed",
				"endgame_gate_report",
				"endgame_gate_pass",
				"endgame_gate_failed",
			]
